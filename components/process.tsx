      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4" data-aos="fade-up">Apa sih yang kita berikan untuk anda?</h2>
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">Kepuasan konsumen menjadi prioritas kami dengan memberikan pelayanan terbaik dan sparepart yang berkualitas.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">1</span>. Pelayanan</h4>
              <p className="text-lg text-gray-400 text-center">Kami memberikan pelayanan terbaik dengan standarisasi service center yang selalu fast respond.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">2</span>. Berkualitas</h4>
              <p className="text-lg text-gray-400 text-center">Kami memberikan kualitas sparepart yang memiliki standarisasi original.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">3</span>. Bergaransi</h4>
              <p className="text-lg text-gray-400 text-center">Kami memberikan garansi dari setiap jasa yang kita berikan.</p>
            </div>
