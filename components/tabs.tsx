      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12" data-aos-id-tabs>
            <h2 className="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-tabs]">Jasa apa saja yang Candra Apple Solution berikan?</h2>
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-tabs]">Memberikan solusi apa yang pelanggan kami butuhkan dengan memberikan jasa service terbaik.</p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap justify-center -m-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-tabs]">
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Hardware</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Software</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Sparepart</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Maintenance</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Training</span>
              </button>
            </div>
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                      ...
                      <p className="text-lg text-gray-400">Kami memberikan solusi jasa service hardware bagi para pengguna yang memiliki permasalahan di apple device seperti mati total, terkena air, jatuh/dibanting, yang dimana apple device anda membutuhkan penangan hardware yang di tangani oleh teknisi professional.</p>
                      <a className="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6" href="/blog">
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pl-16 md:max-w-lg lg:max-w-xl md:ml-auto">
                      ...
                      <p className="text-lg text-gray-400">Kami memberikan solusi jasa service software bagi para pengguna yang memiliki permasalahan di apple device seperti restart, stuck logo apple, beberapa fitur yang tidak berfungsi, dan update os yang dimana apple device anda membutuhkan penangan software yang di tangani oleh teknisi professional.</p>
                      <a className="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6" href="/blog">
                        <span className="text-sm">Learn more</span>
                        <svg className="w-3 h-3 fill-current text-purple-400 shrink-0 ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 5H0v2h6v4l6-5-6-5z" />
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                      ...
                      <p className="text-lg text-gray-400">Kami memberikan solusi jasa service sparepart bagi para pengguna yang memiliki permasalahan di apple device seperti batrai, lcd, kamera, speaker, keyboard, trackpad, dan lain-lain yang dimana apple device anda membutuhkan penangan sparepart yang di tangani oleh teknisi professional.</p>
                      <a className="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6" href="/blog">
                        <span className="text-sm">Learn more</span>
                        <svg className="w-3 h-3 fill-current text-purple-400 shrink-0 ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 5H0v2h6v4l6-5-6-5z" />
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pl-16 md:max-w-lg lg:max-w-xl md:ml-auto">
                      ...
                      <p className="text-lg text-gray-400">Kami memberikan solusi maintenance bagi para pengguna yang memiliki permasalahan di apple device seperti mesin macbook yang kotor, pergantian thermal pasta pada macbook, backup data, dan lain-lain yang dimana apple device anda membutuhkan penangan maintenance yang di tangani oleh teknisi professional.</p>
                      <a className="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6" href="/blog">
                        <span className="text-sm">Learn more</span>
                        <svg className="w-3 h-3 fill-current text-purple-400 shrink-0 ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 5H0v2h6v4l6-5-6-5z" />
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                      ...
                      <p className="text-lg text-gray-400">Kami membuka training private service iphone bagi para teknisi yang ingin belajar service iphone untuk menjadi professional dibidang service iphone yang langsung didampingi oleh bang candra yang memiliki pengalaman service iphone sejak tahun 2015</p>
                      <a className="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6" href="https://academy.caps.co.id">
                        <span className="text-sm">Learn more</span>
                        <svg className="w-3 h-3 fill-current text-purple-400 shrink-0 ml-2" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 5H0v2h6v4l6-5-6-5z" />
                        </svg>
